...
public class ActivityOfItem3 extends Activity {
        ...
        alt0.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ActivityOfItem3.this, MainActivity.class);
        ...
        alt1.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ActivityOfItem3.this, ActivityOfItem2.class);
                        startActivity(intent);
                    }
                });
        ...
        alt3.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ActivityOfItem3.this, ActivityOfItem4.class);
                        startActivity(intent);
                    }
                });
    }
